...
function Library:Create(table)
    ...
    local executorName = ""
    if syn then executorName = "Synapse"
    elseif fluxus then executorName = "Fluxus"
    elseif getgenv().Delta then executorName = "Delta"
    elseif getgenv().Arceus then executorName = "Arceus"
    elseif Krnl then executorName = "Krnl"
    elseif getgenv().VegaX then executorName = "VegaX"
    elseif getgenv().Comet then executorName = "Comet"
    elseif getgenv().Evon then executorName = "Evon"
    elseif getgenv().Valyse then executorName = "Valyse"
    elseif getgenv().Oxygen then executorName = "Oxygen"
    elseif getgenv().Trigon then executorName = "Trigon"
    elseif getgenv().Coco then executorName = "Coco"
    elseif getgenv().Codex then executorName = "Codex"
    elseif getgenv().Wave then executorName = "Wave"
    elseif getgenv().JJSploit then executorName = "JJSploit"
    elseif getgenv().ScriptWare then executorName = "ScriptWare"
    elseif getgenv().Electron then executorName = "Electron"
    elseif getgenv().Sentinel then executorName = "Sentinel"
    end
    ...
    title.Text = windowName .. (executorName ~= "" and " - " or "")
    ...
    if executorName ~= "" then
        ...
        executorLabel.TextColor3 = Color3.fromRGB(0, 120, 255)
        executorLabel.TextSize = 16
        executorLabel.BackgroundTransparency = 1
        executorLabel.Position = UDim2.fromOffset(title.Position.X.Offset + title.TextBounds.X + 5, 9)
        executorLabel.Size = UDim2.fromOffset(100, 20)
